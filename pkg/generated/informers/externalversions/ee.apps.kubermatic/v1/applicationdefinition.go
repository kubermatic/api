	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubermaticEnterpriseAppsV1().ApplicationDefinitions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubermaticEnterpriseAppsV1().ApplicationDefinitions(namespace).Watch(context.TODO(), options)
			},
		},
		&eeappskubermaticv1.ApplicationDefinition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eeappskubermaticv1.ApplicationDefinition{}, f.defaultInformer)
}
