...
import (
	...
	v1 "k8c.io/api/v3/pkg/generated/listers/ee.apps.kubermatic/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubermaticEnterpriseAppsV1().ApplicationInstallations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubermaticEnterpriseAppsV1().ApplicationInstallations(namespace).Watch(context.TODO(), options)
			},
		},
		&eeappskubermaticv1.ApplicationInstallation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInstallationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eeappskubermaticv1.ApplicationInstallation{}, f.defaultInformer)
}
