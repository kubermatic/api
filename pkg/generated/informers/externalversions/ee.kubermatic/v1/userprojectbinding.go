	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubermaticEnterpriseV1().UserProjectBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubermaticEnterpriseV1().UserProjectBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&eekubermaticv1.UserProjectBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userProjectBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eekubermaticv1.UserProjectBinding{}, f.defaultInformer)
}
