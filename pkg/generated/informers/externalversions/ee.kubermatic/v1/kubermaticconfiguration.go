	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubermaticEnterpriseV1().KubermaticConfigurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubermaticEnterpriseV1().KubermaticConfigurations(namespace).Watch(context.TODO(), options)
			},
		},
		&eekubermaticv1.KubermaticConfiguration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubermaticConfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eekubermaticv1.KubermaticConfiguration{}, f.defaultInformer)
}
