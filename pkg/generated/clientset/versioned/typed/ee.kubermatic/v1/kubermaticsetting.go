...
type KubermaticSettingsGetter interface {
	KubermaticSettings(namespace string) KubermaticSettingInterface
}
...
func newKubermaticSettings(c *KubermaticEnterpriseV1Client, namespace string) *kubermaticSettings {
