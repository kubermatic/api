...
var clustersResource = schema.GroupVersionResource{Group: "kubermatic.k8c.io", Version: "v1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "kubermatic.k8c.io", Version: "v1", Kind: "Cluster"}
...
func (c *FakeClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubermaticv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clustersResource, c.ns, name), &kubermaticv1.Cluster{})
...
func (c *FakeClusters) List(ctx context.Context, opts v1.ListOptions) (result *kubermaticv1.ClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clustersResource, clustersKind, c.ns, opts), &kubermaticv1.ClusterList{})
...
func (c *FakeClusters) Create(ctx context.Context, cluster *kubermaticv1.Cluster, opts v1.CreateOptions) (result *kubermaticv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clustersResource, c.ns, cluster), &kubermaticv1.Cluster{})
...
func (c *FakeClusters) Update(ctx context.Context, cluster *kubermaticv1.Cluster, opts v1.UpdateOptions) (result *kubermaticv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clustersResource, c.ns, cluster), &kubermaticv1.Cluster{})
...
func (c *FakeClusters) UpdateStatus(ctx context.Context, cluster *kubermaticv1.Cluster, opts v1.UpdateOptions) (*kubermaticv1.Cluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clustersResource, "status", c.ns, cluster), &kubermaticv1.Cluster{})
...
func (c *FakeClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(clustersResource, c.ns, name, opts), &kubermaticv1.Cluster{})
...
func (c *FakeClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *kubermaticv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clustersResource, c.ns, name, pt, data, subresources...), &kubermaticv1.Cluster{})
