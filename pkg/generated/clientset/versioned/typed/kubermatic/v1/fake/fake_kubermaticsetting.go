...
var kubermaticsettingsResource = schema.GroupVersionResource{Group: "kubermatic.k8c.io", Version: "v1", Resource: "kubermaticsettings"}

var kubermaticsettingsKind = schema.GroupVersionKind{Group: "kubermatic.k8c.io", Version: "v1", Kind: "KubermaticSetting"}
...
func (c *FakeKubermaticSettings) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubermaticv1.KubermaticSetting, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(kubermaticsettingsResource, c.ns, name), &kubermaticv1.KubermaticSetting{})
...
func (c *FakeKubermaticSettings) List(ctx context.Context, opts v1.ListOptions) (result *kubermaticv1.KubermaticSettingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(kubermaticsettingsResource, kubermaticsettingsKind, c.ns, opts), &kubermaticv1.KubermaticSettingList{})
...
func (c *FakeKubermaticSettings) Create(ctx context.Context, kubermaticSetting *kubermaticv1.KubermaticSetting, opts v1.CreateOptions) (result *kubermaticv1.KubermaticSetting, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(kubermaticsettingsResource, c.ns, kubermaticSetting), &kubermaticv1.KubermaticSetting{})
...
func (c *FakeKubermaticSettings) Update(ctx context.Context, kubermaticSetting *kubermaticv1.KubermaticSetting, opts v1.UpdateOptions) (result *kubermaticv1.KubermaticSetting, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(kubermaticsettingsResource, c.ns, kubermaticSetting), &kubermaticv1.KubermaticSetting{})
...
func (c *FakeKubermaticSettings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(kubermaticsettingsResource, c.ns, name, opts), &kubermaticv1.KubermaticSetting{})
...
func (c *FakeKubermaticSettings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *kubermaticv1.KubermaticSetting, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(kubermaticsettingsResource, c.ns, name, pt, data, subresources...), &kubermaticv1.KubermaticSetting{})
