...
var userprojectbindingsResource = schema.GroupVersionResource{Group: "kubermatic.k8c.io", Version: "v1", Resource: "userprojectbindings"}

var userprojectbindingsKind = schema.GroupVersionKind{Group: "kubermatic.k8c.io", Version: "v1", Kind: "UserProjectBinding"}
...
func (c *FakeUserProjectBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubermaticv1.UserProjectBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(userprojectbindingsResource, c.ns, name), &kubermaticv1.UserProjectBinding{})
...
func (c *FakeUserProjectBindings) List(ctx context.Context, opts v1.ListOptions) (result *kubermaticv1.UserProjectBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(userprojectbindingsResource, userprojectbindingsKind, c.ns, opts), &kubermaticv1.UserProjectBindingList{})
...
func (c *FakeUserProjectBindings) Create(ctx context.Context, userProjectBinding *kubermaticv1.UserProjectBinding, opts v1.CreateOptions) (result *kubermaticv1.UserProjectBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(userprojectbindingsResource, c.ns, userProjectBinding), &kubermaticv1.UserProjectBinding{})
...
func (c *FakeUserProjectBindings) Update(ctx context.Context, userProjectBinding *kubermaticv1.UserProjectBinding, opts v1.UpdateOptions) (result *kubermaticv1.UserProjectBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(userprojectbindingsResource, c.ns, userProjectBinding), &kubermaticv1.UserProjectBinding{})
...
func (c *FakeUserProjectBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(userprojectbindingsResource, c.ns, name, opts), &kubermaticv1.UserProjectBinding{})
...
func (c *FakeUserProjectBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *kubermaticv1.UserProjectBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(userprojectbindingsResource, c.ns, name, pt, data, subresources...), &kubermaticv1.UserProjectBinding{})
