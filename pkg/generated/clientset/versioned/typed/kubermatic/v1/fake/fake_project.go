...
var projectsResource = schema.GroupVersionResource{Group: "kubermatic.k8c.io", Version: "v1", Resource: "projects"}

var projectsKind = schema.GroupVersionKind{Group: "kubermatic.k8c.io", Version: "v1", Kind: "Project"}
...
func (c *FakeProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubermaticv1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(projectsResource, c.ns, name), &kubermaticv1.Project{})
...
func (c *FakeProjects) List(ctx context.Context, opts v1.ListOptions) (result *kubermaticv1.ProjectList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(projectsResource, projectsKind, c.ns, opts), &kubermaticv1.ProjectList{})
...
func (c *FakeProjects) Create(ctx context.Context, project *kubermaticv1.Project, opts v1.CreateOptions) (result *kubermaticv1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(projectsResource, c.ns, project), &kubermaticv1.Project{})
...
func (c *FakeProjects) Update(ctx context.Context, project *kubermaticv1.Project, opts v1.UpdateOptions) (result *kubermaticv1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(projectsResource, c.ns, project), &kubermaticv1.Project{})
...
func (c *FakeProjects) UpdateStatus(ctx context.Context, project *kubermaticv1.Project, opts v1.UpdateOptions) (*kubermaticv1.Project, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(projectsResource, "status", c.ns, project), &kubermaticv1.Project{})
...
func (c *FakeProjects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(projectsResource, c.ns, name, opts), &kubermaticv1.Project{})
...
func (c *FakeProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *kubermaticv1.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(projectsResource, c.ns, name, pt, data, subresources...), &kubermaticv1.Project{})
