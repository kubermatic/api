...
var addonconfigsResource = schema.GroupVersionResource{Group: "kubermatic.k8c.io", Version: "v1", Resource: "addonconfigs"}

var addonconfigsKind = schema.GroupVersionKind{Group: "kubermatic.k8c.io", Version: "v1", Kind: "AddonConfig"}
...
func (c *FakeAddonConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(addonconfigsResource, c.ns, name, opts), &kubermaticv1.AddonConfig{})
