...
func newSeeds(c *KubermaticV1Client, namespace string) *seeds {
	return &seeds{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *seeds) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Seed, err error) {
	result = &v1.Seed{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("seeds").
...
func (c *seeds) List(ctx context.Context, opts metav1.ListOptions) (result *v1.SeedList, err error) {
...
func (c *seeds) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *seeds) Create(ctx context.Context, seed *v1.Seed, opts metav1.CreateOptions) (result *v1.Seed, err error) {
	result = &v1.Seed{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("seeds").
...
func (c *seeds) Update(ctx context.Context, seed *v1.Seed, opts metav1.UpdateOptions) (result *v1.Seed, err error) {
	result = &v1.Seed{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seeds").
...
func (c *seeds) UpdateStatus(ctx context.Context, seed *v1.Seed, opts metav1.UpdateOptions) (result *v1.Seed, err error) {
	result = &v1.Seed{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seeds").
...
func (c *seeds) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *seeds) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *seeds) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Seed, err error) {
	result = &v1.Seed{}
