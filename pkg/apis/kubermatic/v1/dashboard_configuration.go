...
// DashboardConfiguration is the type representing a DashboardConfiguration.
type DashboardConfiguration struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec DashboardConfigurationSpec `json:"spec,omitempty"`
}

type DashboardConfigurationSpec struct {
...
func (s DashboardConfigurationSpec) HasDefaultProjectResourceQuota() bool {
